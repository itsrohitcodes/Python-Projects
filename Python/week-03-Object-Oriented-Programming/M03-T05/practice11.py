# Test a Student with no Matching Skills
...
# Create both analyzers and print their results.
score_analyzer = MatchScoreCalculator(student, job)
missing_detector = MissingSkillDetector(student, job)

print(f"Match Score: {score_analyzer.analyze()}")
